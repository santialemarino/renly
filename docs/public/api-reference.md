...
| Code  | Meaning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `400` | Bad request -- e.g., a snapshot/transaction `currency` that doesn't match its investment's `base_currency`, or an invalid transfer (`transfer_same_account`, `transfer_amounts_must_match`, `transfer_amount_required`), or a group-invite link that is unknown, already used or expired (`invalid_token`), or an ownership movement that cannot be priced or afforded (`pot_not_opened`, `pot_valuation_required`, `pot_insufficient_units`, `pot_percentages_must_total_100`), or a flow crossing a scope boundary (`private_entry_from_shared_account`, `transfer_cross_scope`).                                                                                                                                                                                                                                                                        |
