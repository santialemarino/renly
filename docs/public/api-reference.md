...
The **flow** half of shared money. A pot divides what a household _holds_; this divides what it _spends_, and the two never mix: a shared expense lives in its own tables and each member's share is read into their normal expenses list rather than mirrored into it.
