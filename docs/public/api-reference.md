...
| `PUT`    | `/groups/{id}/members/{member_id}`        | Update `display_name`, `role`, or `is_active` (to bring a former member back). Admin only.                               |
...
| Code  | Meaning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `400` | Bad request -- e.g., a snapshot/transaction `currency` that doesn't match its investment's `base_currency`, or an invalid transfer (`transfer_same_account`, `transfer_amounts_must_match`, `transfer_amount_required`), or a group-invite link that is unknown, already used or expired (`invalid_token`).                                                                                                                                                                                                                                                                               |
| `401` | Unauthorized -- missing or invalid token.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `403` | Forbidden -- an admin-only action attempted by a plain member (`group_admin_required`), or an unverified email at login.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
