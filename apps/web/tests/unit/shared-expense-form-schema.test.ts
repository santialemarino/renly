...
/*
 * The split editor's arithmetic and the four money forms' rules.
 *
 ...
 * submit, and shows the user a total that reads as balanced. Every case below that uses uneven
 * thirds is checking exactly that, and none of them would fail with float arithmetic in a way a
 * developer would notice by eye.
 */
