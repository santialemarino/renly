...
async def get_snapshot_grid(
    ...
    search: str | None = Query(default=None, max_length=SEARCH_MAX_LENGTH, description="Filter by investment name."),
    ...
    sort_by: str | None = Query(default=None, max_length=CODE_MAX_LENGTH, description="Sort field: name."),
