...
- [ ] Settings page (§11.5): form to configure display currencies (and order) + default currency; GET/PUT settings API; page is placeholder for future options
...
- No investments list/detail, no data-entry, no settings page, no currency switch.
